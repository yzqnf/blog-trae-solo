...
export const articles = [
  ...
  },
  {
    ...
    date: '2024-01-10',
    category: '前端',
    excerpt: 'Element Plus 是基于 Vue 3 的 UI 组件库，本文介绍其主要组件的使用方法和最佳实践...',
    content: '<h2>Element Plus 简介</h2>\n<p>Element Plus 是基于 Vue 3 的 UI 组件库，是 Element UI 的升级版本，为开发者提供了一套美观、实用的组件。</p>'
  },
  {
    id: 3,
    title: 'Vite 构建工具性能优化',
    date: '2024-01-05',
    category: '工具',
    excerpt: 'Vite 是现代化的前端构建工具，本文分享一些性能优化技巧，提升开发和构建效率...',
    content: '<h2>Vite 性能优化指南</h2>\n<p>Vite 是一个现代化的前端构建工具，以其快速的开发服务器和高效的构建过程而闻名。本文将分享一些 Vite 性能优化的技巧。</p>'
  },
  {
    id: 4,
    ...
    date: '2023-12-20',
    category: '前端',
    excerpt: '深入了解 JavaScript 异步编程，包括 Promise、async/await 和事件循环...',
    content: '<h2>JavaScript 异步编程</h2>\n<p>异步编程是 JavaScript 中的一个重要概念，本文将深入探讨 JavaScript 中的异步编程模型。</p>'
  }
]
...
// 获取相关文章
export function getRelatedArticles(articleId, category, limit = 3) {
  return articles
    .filter(article => article.id !== parseInt(articleId) && article.category === category)
    .slice(0, limit)
}
